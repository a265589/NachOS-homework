...
public:
    ...
    bool type;                     //陳柏均新增的　用以表示是directory:0 還是 file:1
...
public:
    ...
    int Find(char *name, int *type);                //陳柏均新增的
                                                    // bool Add(char *name, int newSector);
                                                    // Add a file name into the directory
    bool Add(char *name, int newSector, bool type); //陳柏均改過的

    DirectoryEntry *getEntryTable(); //陳柏均新增的
